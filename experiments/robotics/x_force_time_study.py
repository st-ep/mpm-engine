"""Reproducible force-amplitude/duration planning using the common A/B fits."""
...
from experiments.robotics import x_force_time_control as control
...
OUT = ROOT / 'out/x_force_time_study_20260910'
...
PROTOCOL = dict(scene=core.CONFIG, control=control.CONTROL,
    ...
    pilot=dict(force_factors=[.95, 1.05, 1.20], durations_s=[.4, .8, 1.2],
    ...
    pulse='Raised-cosine rise over first 20%, constant force for 60%, raised-cosine fall over last 20%',
...
def prepare(folder):
    ...
    source_paths += ['experiments/robotics/x_force_time_control.py', 'experiments/robotics/x_force_time_study.py']
    hashes = {}
