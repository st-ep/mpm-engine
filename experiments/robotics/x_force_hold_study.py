...
from experiments.robotics import x_force_hold_control as control
...
OUT = ROOT / 'out/x_force_hold_study_20260910'
...
def prepare(folder):
    ...
    source_paths += ['experiments/robotics/x_force_hold_control.py', 'experiments/robotics/x_force_hold_study.py']
    hashes = {}
