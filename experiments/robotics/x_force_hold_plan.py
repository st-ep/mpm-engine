...
The pilot and its controller remain frozen in x_force_hold_study. This stage
...
from experiments.robotics import x_force_hold_study as study
from experiments.robotics.plastic_shaping_study import save_json

PLAN_PROTOCOL = dict(
    initial_force_factor='Force factor of the feasible pilot nearest the model reference first opening; identical A/B rule',
    ...
    force_bounds_n=[.05, 14.], duration_bounds_s=[.08, 1.5],
...
def initialize(folder, material, device):
    ...
    pilot = json.loads((folder / f'pilot/{material}/selected.json').read_text())
