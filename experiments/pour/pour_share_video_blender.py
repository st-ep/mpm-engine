"""Render the private pouring animation with the existing paper scene's style.
...
parser.add_argument("--output", type=Path, default=ROOT / "out/pour_share_video_20260911")
...
selected = devices[min(1, len(devices)-1)]
