"""Audit the two diagnostic MPM probes without reading real liquid outcomes.
...
def main():
    ...
    case = WORK / f'candidate_mu{args.contact:.6f}/diagnostic_timing_probe_{args.angle:.2f}'
    ...
    assert protocol['diagnostic_only'] and not protocol['numerical_acceptance_passed']
    ...
    output = dict(purpose=__doc__, angle_deg=args.angle, eta_pa_s=result['eta_pa_s'],
        ...
        real_error_forecast_saved=False, bulk_search_queued=False, diagnostic_only=True,
