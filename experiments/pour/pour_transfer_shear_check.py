...
args.variant=source.parent.name
...
def main():
    ...
    protocol=dict(candidate_manifest_sha256=hashlib.sha256(manifest.read_bytes()).hexdigest() if manifest.exists() else None, purpose=__doc__,variant=args.variant,grid=args.grid,extent_m=.035,
