...
def data():
 ...
 return dict(hp=hp,kin=kin,tr=tr,force=force,camera=camera,camera_right=camera_right,ids=ids,hsel=hsel,hproj=hproj,sproj=sproj,crop=crop,rgb=rgb,reference=reference,disp_max_m=disp_max_m)
...
def draw_method01(t):
 ...
 for ci,x in [(0,578),(1,660)]:
  ...
  c.text(x+32,488,'Left view' if ci==0 else 'Right view',12,MUTED,anchor='mt')
