...
def data():
 ...
 sproj=Projection(local.reshape(-1,3),(769,491,159,134),az=-52,el=24)
...
def draw_observations(c,D,t,sf,clock=0.,arrow_alpha=1.):
 ...
 if arrow_alpha>0:
  ...
  c.line([(44,y),(336,y)],col,4);c.poly([(334,y-7.5),(350,y),(334,y+7.5)],col)
...
def static_frame():
 ...
 c.text(650,424,'Flow prior',15.5,MUTED,anchor='mt')
 ...
 c.line([(956,205),(973,205),(973,691),(956,691)],TEAL,1.5)
 c.dot((973,448),2.4);c.arrow((973,448),(1007,448),TEAL,2.4,8)
 return im
