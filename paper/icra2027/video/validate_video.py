 ...
 *SOURCES.values(),ROOT/'paper/videos/provenance.json',ROOT/'paper/videos/README.md',
 ...
 ROOT/'pouring_real_data/pouring_figs/group_photo_provenance.json',
